...
- **Tuesday Readings**
  ...
  This is a video-only tutorial, rather than a hands-on tutorial, so it will take less time to complete than the HTML Essential Training course. Some of it will be review from past classes, but most of it goes into more detail than the prerequisite classes provide. 
